...
def config_aware_init(class_: type[T]) -> type[T]:
    ...
    Supports both explicit mappings and convention-based automatic mapping.
    Classes can define their own mappings using a _config_mappings attribute.
    ...
    Example:
        >>> @config_aware_init
        ... class DataProcessor:
        ...     # Optional: define custom mappings
        ...     _config_mappings = {"custom_param": "custom.config.path"}
        ...
    ...
    def new_init(self, *args: Any, **kwargs: Any) -> None:
        import inspect
        from .param_mapping import ParamMapper, get_class_param_mappings, merge_param_mappings

        sig = inspect.signature(original_init)

        # Get parameter mappings from multiple sources
        ...
        for param_name, param in sig.parameters.items():
            ...
            if (config_path and param_name not in kwargs and
