...
class TransformerFactory:
    ...
    def register_transformer(cls, name: str, transformer_class: Type[DataTransformer]) -> None:
        ...
        if not issubclass(transformer_class, DataTransformer):
            raise TypeError(f"Transformer class must be a subclass of DataTransformer")
        ...
        try:
            ...
            for _, module_name, _ in pkgutil.iter_modules(package_path):
                ...
                for name, obj in inspect.getmembers(module):
                    if inspect.isclass(obj) and issubclass(obj, DataTransformer) and obj != DataTransformer:
            ...
            logger.error(f"Error discovering transformers from package '{package_name}': {e}")
            
    @classmethod
    def create_composite_transformer(cls, transformer_names: List[str], **kwargs) -> DataTransformer:
        """
