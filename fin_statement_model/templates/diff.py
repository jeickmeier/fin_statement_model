...
def diff(
    ...
    *,
    ...
    Example:
        ...
        ...     len(full_diff.structure.added_nodes) > 0
        ...     or len(full_diff.structure.removed_nodes) > 0
        ...     or len(full_diff.structure.changed_nodes) > 0
        ... )
        >>>
        >>> has_value_changes = full_diff.values is not None and len(full_diff.values.changed_cells) > 0
