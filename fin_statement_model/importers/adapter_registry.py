...
class AdapterRegistry:
    ...
    @classmethod
    def register(cls, adapter_type: str, config_key: str, adapter: DataSourceAdapter) -> None:
        """
        ...
        logger.debug(f"Registered adapter instance of type '{adapter_type}' with config key '{config_key}'")
    ...
    def get(cls, adapter_type: str, config_key: str) -> Optional[DataSourceAdapter]:
        ...
        """
        if adapter_type not in cls._instances or config_key not in cls._instances[adapter_type]:
            return None
        
        logger.debug(f"Retrieved adapter instance of type '{adapter_type}' with config key '{config_key}'")
        return cls._instances[adapter_type][config_key]
    
    @classmethod
    def get_or_create(cls, adapter_type: str, config_key: str, **config) -> DataSourceAdapter:
        """
        ...
        logger.debug(f"Creating new adapter instance of type '{adapter_type}' with config key '{config_key}'")
    ...
    def remove(cls, adapter_type: str, config_key: str) -> bool:
        ...
        logger.debug(f"Removed adapter instance of type '{adapter_type}' with config key '{config_key}'")
