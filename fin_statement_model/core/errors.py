...
class ConfigurationError(FinancialModelError):
    ...
    def __init__(self, message: str, config_path: Optional[str] = None, errors: Optional[List[str]] = None):
...
class CalculationError(FinancialModelError):
    ...
    def __init__(self, message: str, node_id: Optional[str] = None, 
                 period: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
...
class ImportError(FinancialModelError):
    ...
    def __init__(self, message: str, source: Optional[str] = None, 
                 adapter: Optional[str] = None, original_error: Optional[Exception] = None):
        self.source = source
...
class ExportError(FinancialModelError):
    ...
    def __init__(self, message: str, target: Optional[str] = None, 
                 format_type: Optional[str] = None, original_error: Optional[Exception] = None):
        self.target = target
...
class TransformationError(FinancialModelError):
    ...
    def __init__(self, message: str, transformer_type: Optional[str] = None, 
