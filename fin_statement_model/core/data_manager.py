...
class DataManager:
    ...
    def update_item(self, name: str, values: Dict[str, float], replace_existing: bool = False) -> Node:
        """
                ...
                try:
                    ...
                    for input_node in node.inputs:
                        if hasattr(input_node, 'name') and input_node.name == name:
                            raise ValueError(f"Cannot delete node '{name}' because it is referenced by '{node_name}'")
