...
class ExportManager:
    ...
    def to_dataframe(self, graph: Graph, recalculate: bool = True, 
                    node_names: Optional[List[str]] = None) -> pd.DataFrame:
        """
    ...
    def to_excel(self, graph: Graph, file_path: Union[str, Path], 
    ...
    def to_csv(self, graph: Graph, file_path: Union[str, Path],
              include_header: bool = True) -> None:
        """
    ...
    def to_json(self, graph: Graph, file_path: Optional[Union[str, Path]] = None,
               pretty_print: bool = True, include_calculation_nodes: bool = True) -> Union[str, None]:
        """
        ...
        for node_name, node in graph.nodes.items():
            ...
            if not include_calculation_nodes and hasattr(node, 'inputs') and node.inputs:
                continue
    ...
    def to_html(self, graph: Graph, file_path: Optional[Union[str, Path]] = None,
               include_styles: bool = True, title: str = "Financial Statement") -> Union[str, None]:
        """
